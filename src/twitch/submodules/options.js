            ...
            if (typeof optionToChange !== "undefined") {
                if (typeof optionValue !== "undefined") {
                    if (optionToChange == 'insultthreshold') {
                        ...
                        .catch(error => TMI.say(channel, `There was an error changing channel options, please double check your message, if you dont see an issue contact support at http://adfoc.us/54699276543906\r error: ${error}`))
